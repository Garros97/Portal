...
$(function () {
    ...
    function row(...args) {
        ...
        var deleteRegistrationPrompt = "Wollen Sie diese Registrierung wirklich löschen? Dadurch wird der Teilnehmende von diesem Projekt abgemeldet.";
