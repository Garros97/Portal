...
/*
 * Set the default format the is used when using Time instance as a string.
 */
\Cake\I18n\FrozenTime::setToStringFormat('dd.MM.yy, HH:mm \'Uhr\''); //TODO: Smaller space here? (Something unicode...)
...
Application::addPlugin('CakePdf', ['bootstrap' => true, 'routes' => true]);
Application::addPlugin('Duplicatable');
